...
data class Conversation(val id: String = "", var name: String = "", val lastMsg: String = "", val lastActivity: Long = 0, val unread: Int = 0, val avatar: String = "", val color: Long = 0xFF818CF8, val online: Boolean = false, val isGroup: Boolean = false, var otherId: String = "")
